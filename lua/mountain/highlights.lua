...
highlights.generate_syntax = function(palette, options)
	...
	local function set_signs_background_colour(colour_to_set)
		if options.transparent or options.sign_column_background == "none" then
			return palette.none
		else
			return colour_to_set
		end
	...
	---@type Highlights
	local syntax = {
		Normal = syntax_entry(palette.fg, transparency_respecting_colour(palette.bg)),
		NormalNC = syntax_entry(
			palette.fg,
			transparency_respecting_colour((options.dim_inactive and palette.bg_dim) or palette.bg)
		),
		Terminal = syntax_entry(palette.fg, transparency_respecting_colour(palette.bg)),
		EndOfBuffer = syntax_entry(palette.bg, palette.none),
		...
		FoldColumn = syntax_entry(
			(options.sign_column_background == "grey" and palette.grey2) or palette.bg3,
			sign_column_respecting_colour(palette.bg1)
		),
		ToolbarLine = syntax_entry(palette.fg, transparency_respecting_colour(palette.bg2)),
		IncSearch = syntax_entry(palette.bg, palette.red),
		Search = syntax_entry(palette.bg, palette.green),
		ColorColumn = syntax_entry(palette.none, palette.bg1),
		Conceal = syntax_entry(set_colour_based_on_ui_contrast(palette.bg3, palette.grey0), palette.none),
		...
		LineNr = syntax_entry(set_colour_based_on_ui_contrast(palette.bg3, palette.grey0), palette.none),
		CursorLineNr = syntax_entry(
			set_colour_based_on_ui_contrast(palette.grey1, palette.grey2),
			sign_column_respecting_colour(palette.bg1)
		),

		DiffAdd = syntax_entry(palette.green, palette.none),
		DiffChange = syntax_entry(palette.blue, palette.none),
		DiffDelete = syntax_entry(palette.red, palette.none),
		DiffText = syntax_entry(palette.bg, palette.blue),
		...
		Whitespace = syntax_entry(palette.bg3, palette.none),
		...
		PmenuSel = syntax_entry(palette.grey2, palette.bg1),
		...
		SpellBad = syntax_entry(palette.red, palette.none, { styles.undercurl }, palette.red),
		SpellCap = syntax_entry(palette.blue, palette.none, { styles.undercurl }, palette.blue),
		SpellLocal = syntax_entry(palette.aqua, palette.none, { styles.undercurl }, palette.aqua),
		SpellRare = syntax_entry(palette.purple, palette.none, { styles.undercurl }, palette.purple),

		StatusLine = syntax_entry(palette.grey1, options.transparent and palette.none or palette.bg2),
		StatusLineTerm = syntax_entry(palette.grey1, options.transparent and palette.none or palette.bg1),
		StatusLineNC = syntax_entry(
			options.transparent and palette.grey0 or palette.grey1,
			options.transparent and palette.none or palette.bg1
		),
		StatusLineTermNC = syntax_entry(
			options.transparent and palette.grey0 or palette.grey1,
			options.transparent and palette.none or palette.bg
		),
		TabLine = syntax_entry(palette.grey2, palette.bg1),
		TabLineFill = syntax_entry(palette.grey1, options.transparent and palette.none or palette.bg),
		TabLineSel = syntax_entry(palette.fg, palette.bg),
		VertSplit = syntax_entry(palette.bg3, (options.dim_inactive and palette.bg_dim) or palette.none),
		...
		debugPC = syntax_entry(palette.bg, palette.green),
		debugBreakpoint = syntax_entry(palette.bg, palette.red),
		ToolbarButton = syntax_entry(palette.bg, palette.green),
		Substitute = syntax_entry(palette.bg, palette.yellow),
		WinBarNC = { link = "Grey" },
		...
		Todo = syntax_entry(palette.bg, palette.blue, { styles.bold }),
		...
		TSNote = syntax_entry(palette.bg, palette.green, { styles.bold }),
		TSWarning = syntax_entry(palette.bg, palette.yellow, { styles.bold }),
		TSDanger = syntax_entry(palette.bg, palette.red, { styles.bold }),
		...
		CtrlPMode2 = syntax_entry(palette.bg, palette.blue, { styles.bold }),
		...
		IblIndent = syntax_entry(palette.bg3, palette.none, { styles.nocombine }),
		...
		-- romgrk/barbar.nvim
		BufferCurrent = syntax_entry(palette.fg, palette.bg),
		BufferCurrentIndex = syntax_entry(palette.fg, palette.bg),
		BufferCurrentMod = syntax_entry(palette.blue, palette.bg),
		BufferCurrentSign = syntax_entry(palette.bg, palette.bg),
		BufferCurrentTarget = syntax_entry(palette.red, palette.bg, { styles.bold }),
		...
		BufferVisibleSign = syntax_entry(palette.bg1, palette.bg_dim),
		...
		NotifyBackground = syntax_entry(palette.fg, palette.bg),
		-- Borders
		...
		MiniStatuslineModeCommand = syntax_entry(palette.bg, palette.aqua, { styles.bold }),
		MiniStatuslineModeInsert = syntax_entry(palette.bg, palette.yellow, { styles.bold }),
		MiniStatuslineModeNormal = syntax_entry(palette.bg, palette.green, { styles.bold }),
		MiniStatuslineModeOther = syntax_entry(palette.bg, palette.purple, { styles.bold }),
		MiniStatuslineModeReplace = syntax_entry(palette.bg, palette.orange, { styles.bold }),
		MiniStatuslineModeVisual = syntax_entry(palette.bg, palette.blue, { styles.bold }),
		MiniTablineCurrent = syntax_entry(palette.fg, palette.bg3),
		MiniTablineHidden = syntax_entry(palette.grey1, palette.bg2),
		MiniTablineModifiedCurrent = syntax_entry(palette.blue, palette.bg3),
		...
		MiniTablineTabpagesection = syntax_entry(palette.bg, palette.bg_dim, { styles.bold }),
		...
		LightspeedShortcut = syntax_entry(palette.bg, palette.red, { styles.bold }),
		LightspeedUnlabeledMatch = syntax_entry(palette.fg, palette.none, { styles.bold }),
		LightspeedPendingOpArea = syntax_entry(palette.bg, palette.green),
		...
		OctoViewer = syntax_entry(palette.bg, palette.blue),
		...
		OctoBubbleGreen = syntax_entry(palette.bg, palette.green),
		OctoBubbleRed = syntax_entry(palette.bg, palette.red),
		OctoBubblePurple = syntax_entry(palette.bg, palette.purple),
		OctoBubbleYellow = syntax_entry(palette.bg, palette.yellow),
		OctoBubbleBlue = syntax_entry(palette.bg, palette.blue),
		OctoBubbleGrey = syntax_entry(palette.bg, palette.grey1),
		...
		NeotestNamespace = syntax_entry(palette.green, palette.none),
		...
		NoiceCompletionItemKindVariable = syntax_entry(palette.blue, palette.none),
		NoiceCompletionItemKindConstant = syntax_entry(palette.blue, palette.none),
		NoiceCompletionItemKindReference = syntax_entry(palette.aqua, palette.none),
		NoiceCompletionItemKindValue = syntax_entry(palette.purple, palette.none),
		...
		FSPrefix = syntax_entry(palette.fg, transparency_respecting_colour(palette.bg), { styles.bold }),
	...
	if vim.g.indent_guides_auto_colors == false then
		syntax["IndentGuidesOdd"] = syntax_entry(palette.bg, palette.bg1)
		syntax["IndentGuidesEven"] = syntax_entry(palette.bg, palette.bg2)
	end
	...
	if options.transparent then
		...
		syntax["NvimTreeVertSplit"] = syntax_entry(palette.bg, palette.bg)
		syntax["NvimTreeCursorLine"] = syntax_entry(palette.none, palette.bg)
		...
		syntax["NeoTreeVertSplit"] = syntax_entry(palette.bg, palette.bg)
	end
